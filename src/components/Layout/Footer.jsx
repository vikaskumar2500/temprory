  ...
  return (
    <footer className="footer-container">
      ...
      <div className="footer-icons">
        <ul>
          <li>
            <a className="footer-icon youtube" href="https://www.youtube.com" target="_blank">
              <img src={image3} alt="YouTube" />
            </a>
          </li>
          <li>
            <a className="footer-icon spotify" href="https://spotify.com" target="_blank">
              <img src={image2} alt="Spotify" />
            </a>
          </li>
          <li>
            <a className="footer-icon facebook" href="https://facebook.com" target="_blank">
